...
public class DailyChallengeBackgroundDialog extends JDialog {
	
	DailyChallengeDialog dialog;
    public DailyChallengeBackgroundDialog(JFrame parent) {
	...
	private void initUI() {
        ...
        dialog = new DailyChallengeDialog((JFrame) getParent());
