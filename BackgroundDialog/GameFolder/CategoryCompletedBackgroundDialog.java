...
public class CategoryCompletedBackgroundDialog extends JDialog {

    private CategoryCompletedDialog dialog;

    public CategoryCompletedBackgroundDialog(JFrame parent) {
    ...
    private void initUI() {
        ...
        dialog = new CategoryCompletedDialog((JFrame) getParent());
    }
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                if (dialog != null && dialog.isVisible()) {
                    ...
                    dialog.setLocationRelativeTo(CategoryCompletedBackgroundDialog.this);
                }
            }
        });
    }
