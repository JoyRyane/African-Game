...
//    private ImageIcon resizedSettingsIcon, resizedLanguageIcon,resizedSoundIcon,
//    	resizedThemeIcon,resizedLimitIcon;
...
//        soundLabel = new JLabel("Sound", resizedSoundIcon, JLabel.CENTER);
    ...
    private void initUI() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	JFrame parentFrame = (JFrame) SwingUtilities.getWindowAncestor(SettingsDialog.this);
                // Save current state if OK is clicked
                initialState = toggleButton.getCurrentState();
                Window[] windows = Window.getWindows();
                for (Window window : windows) {
                    if (window instanceof JDialog && window.getOwner() == parentFrame) {
                        JDialog dialog = (JDialog) window;
